...
import raven
import wedsite
from example_wedsite.wedsite_conf import CUSTOMIZED_JSON, CUSTOMIZED_ACCESS
...
WSGI_APPLICATION = 'example_wedsite.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(wedsite.__file__), 'static'),
)
...
# Make a new wedsite JSON object to test overriding things
